...
public class GreetingsBot {
    ...
    public static void main(String[] args) {
         ...
         */
        val greetings = intent("Greetings").trainingSentence("Hello!").trainingSentence("Hi!").trainingSentence("Hello").trainingSentence("Hi");
		...
		.trainingSentence("Banana")		.trainingSentence("Computer")		.trainingSentence("iPhone 15");
        		val BuyPaymentIntent = intent ("BuyPayment")
		.trainingSentence("Credit")		.trainingSentence("Debit");
        		        		
val BuyCreditDeliveryIntent = intent ("BuyCreditDelivery")		.trainingSentence("Home");val BuyDebitDeliveryIntent = intent ("BuyDebitDelivery")		.trainingSentence("Lisbon Store");        	        val SellIntent = intent ("Sell")
        		.trainingSentence("Sell");
        	        		val SellItemsIntent = intent ("SellItems")
		.trainingSentence("Fish Tank")		.trainingSentence("Fish");
        		val SellPaymentIntent = intent ("SellPayment")
		.trainingSentence("Debit")		.trainingSentence("Credit");
        		        		
val SellDebitDeliveryIntent = intent ("SellDebitDelivery")		.trainingSentence("Porto Store")		.trainingSentence("Home");val SellCreditDeliveryIntent = intent ("SellCreditDelivery")		.trainingSentence("Porto Store")		.trainingSentence("Home");     
		...
		val awaitingInputBuySelectItems = state("AwaitingInputBuySelectItems");		val awaitingInputBuySelectPayment = state("AwaitingInputBuySelectPayment");       
		...
		val awaitingInputSellSelectItems = state("AwaitingInputSellSelectItems");		val awaitingInputSellSelectPayment = state("AwaitingInputSellSelectPayment");       
		...
		.when(intentIs(SellIntent)).moveTo(handleSell)
				...
				awaitingInputWeather	.next().moveTo(awaitingInput);
           ...
           awaitingInputBuy	
				...
				reactPlatform.reply(context,"Banana Price:10");				reactPlatform.reply(context,"Computer Price:5");				reactPlatform.reply(context,"iPhone 15 Price:10000000");				}).next()
				.when(intentIs(BuyItemsIntent)).moveTo(awaitingInputBuySelectItems)
				;
...
*/
           ...
           awaitingInputSell	
				...
				reactPlatform.reply(context, "Here are all the available items:");
				reactPlatform.reply(context,"Fish Tank Price:50");				reactPlatform.reply(context,"Fish Price:2");				}).next()
				.when(intentIs(SellItemsIntent)).moveTo(awaitingInputSellSelectItems)
				;
